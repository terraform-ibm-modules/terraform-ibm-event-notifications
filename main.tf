...
resource "ibm_iam_authorization_policy" "cos_policy" {
  ...
  description                 = "Allow EN instance with GUID ${ibm_resource_instance.en_instance.guid} `Object Writer` and `Reader` access to the COS instance with ID ${local.existing_cos_instance_guid}."

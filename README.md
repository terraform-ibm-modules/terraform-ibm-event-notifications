...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/modules/fscloud">fscloud</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/examples/advanced">Advanced example with BYOK encryption and CBR rules</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/examples/basic">Basic example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/examples/fscloud">Financial Services Cloud profile example</a>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/solutions">Deployable Architectures</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-event-notifications/tree/main/solutions/fully-configurable">Cloud automation for Event Notifications (Fully configurable)</a></li>
    </ul>
  </li>
